package com.atong.leek.imagetemp.config;
...
public class PrimaryDataBaseConfig {
     ...
     * dao层的包路径
     */
    static final String PACKAGE = "com.atong.leek.imagetemp.mapper.primary";
    ...
    /**
     * 创建Mybatis的连接会话工厂实例
     * @param primaryDataSource dataSource
